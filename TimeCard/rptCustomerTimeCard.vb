...
Public Class rptCustomerTimeCard
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCustomerTimeCard.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TimeCard.rptCustomerTimeCard.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCustomerTimeCard
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCustomerTimeCard = New rptCustomerTimeCard()
        rpt.Site = Me.Site
        Return rpt
    End Function
